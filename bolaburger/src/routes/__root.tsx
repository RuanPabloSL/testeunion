...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Bola Burger" },
      { name: "description", content: "Sistema de pedidos — Bola Burger" },
      { property: "og:title", content: "Bola Burger" },
      { property: "og:description", content: "Sistema de pedidos — Bola Burger" },
